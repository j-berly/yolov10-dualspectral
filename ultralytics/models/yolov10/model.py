...
from .train import YOLOv10DetectionTrainer, IncrementalYOLOv10DetectionTrainer
...
class IncrementalYOLOv10(Model, PyTorchModelHubMixin, model_card_template=card_template_text):
    ...
    def task_map(self):
        ...
        return {
            "detect": {
                "model": YOLOv10DetectionModel,
                "trainer": IncrementalYOLOv10DetectionTrainer,
                "validator": YOLOv10DetectionValidator,
                "predictor": YOLOv10DetectionPredictor,
            },
        }
